...
#### Mapgen.Analyzer.Abstractions
Contains the public API used by developers:
- `MapperAttribute` - Marks a class as a mapper
- `MapgenProject` - Contains constants like attribute names

#### Mapgen.Analyzer
Contains the source generator implementation with the following structure:
